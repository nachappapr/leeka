...
import type { ActivityFilterId, ActivityGlanceRow, ActivityIconKey, ActivityItem } from "@/lib/types"
...
export const ACTIVITY_GLANCE_ROWS: ReadonlyArray<ActivityGlanceRow> = GLANCE_DEFS.map(
  (r) => ({
    label: r.label,
    tone: r.tone,
