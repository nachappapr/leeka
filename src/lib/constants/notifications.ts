import type { NotificationGroupData, NotificationItemData } from "@/lib/types/notifications";
...
const PANEL_TODAY: NotificationItemData[] = [
  ...
  },
  {
    ...
    verb: "replied on WhatsApp about",
    amount: 8750,
    invoiceNo: "INV-2447",
    tone: "whatsapp",
...
export const ACTIVITY_NOTIFICATIONS: NotificationItemData[] = [
  ...
  },
  {
    ...
    verb: "received your invoice on WhatsApp",
    invoiceNo: "INV-1022",
    timestamp: hoursAgo(3),
    group: "today",
  },
  ...
  },
  {
    id: "a7",
    tone: "sent",
    customer: "Singh Foods",
    verb: "invoice was sent",
    amount: 6100,
    invoiceNo: "INV-1018",
    timestamp: daysAgo(1),
    group: "yesterday",
  ...
  },
  {
    id: "a10",
    tone: "overdue",
    customer: "Ravi Plastics",
    verb: "reminder sent — 7 days overdue on",
    amount: 9800,
    invoiceNo: "INV-1009",
    timestamp: daysAgo(4),
    group: "week",
