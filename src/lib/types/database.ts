...
// Last generated: 2026-06-13 (AP-30: claim_due_reminders RPC applied)
...
export type Database = {
  ...
  public: {
    ...
    Functions: {
      ...
      claim_due_reminders: { Args: Record<PropertyKey, never>; Returns: Json };
      create_business: {
        Args: {
          p_address: string;
          p_gstin: string;
      ...
      sweep_overdue_invoices: { Args: Record<PropertyKey, never>; Returns: Json };
      upsert_customer: {
        Args: {
