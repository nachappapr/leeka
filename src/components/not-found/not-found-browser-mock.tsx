    ...
    <div className="relative">
      <div
        ...
        style={{
          ...
          background:
            "linear-gradient(155deg,#FFE7DA 0%,#FFD8C2 60%,#FFC09A 100%)",
      ...
      <div className="relative z-10 overflow-hidden rounded-2xl border border-line bg-card shadow-float">
        <BrowserChrome
          ...
          leadingIcon={
            <LinkBroken
              className="size-2.5 text-overdue shrink-0"
              aria-hidden="true"
            />
          }
          pathTone="overdue"
        ...
        <div aria-hidden="true" className="flex flex-col items-center text-center px-9 pt-12 pb-11 min-h-95 justify-center bg-background max-mobile:px-6 max-mobile:pt-8 max-mobile:pb-7.5 max-mobile:min-h-62">
          <div className="mb-6.5 max-mobile:mb-4.5">
            <TornDoc
              className="size-33 max-mobile:size-25"
              aria-hidden="true"
            />
          </div>
          ...
          <span className="mt-4.5 inline-flex items-center gap-1.5 rounded-full bg-overdue-soft px-3 py-1 text-label font-extrabold text-overdue-ink">
            <span
              className="size-1.5 rounded-full bg-overdue shrink-0"
              aria-hidden="true"
            />
            No such record
          </span>
      ...
      <div aria-hidden="true" className="absolute z-20 bg-card rounded-lg shadow-float px-3.5 py-3 flex items-center gap-2.5 min-w-49 bottom-5.5 -right-7 animate-float-y max-mobile:hidden max-tablet:right-2">
