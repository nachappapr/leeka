    ...
    >
      ...
      <div className="flex items-start justify-between">
        ...
        <div>
          ...
          <p className="mt-2 text-body font-extrabold text-ink">
            Raj Kumar Trading
          </p>
        ...
        <div className="text-right">
          <p className="text-10 font-extrabold uppercase tracking-wider text-ink-3">
            Invoice
          </p>
          {/* text-coral-ink on bg-card = 12.93:1 ✓ WCAG AA */}
          <p className="text-title-sm font-extrabold text-coral-ink">
            {invoiceIdNoHash}
          </p>
      ...
      <dl className="grid grid-cols-2 gap-3">
        <div>
          <dt className="text-10 font-extrabold uppercase tracking-wider text-ink-3">
            Billed to
          </dt>
      ...
      <dl className="mt-3">
        ...
        <div className="mt-2 flex items-baseline justify-between rounded-sm bg-coral px-3 py-2.5 text-ink">
          <dt className="text-11 font-extrabold uppercase tracking-wider">
            TOTAL DUE
          </dt>
          <dd className="tabular text-20 font-extrabold">
            {formatRupees(total)}
          </dd>
        </div>
      </dl>
      ...
      {/* Footer line */}
      <p className="mt-3.5 text-center text-11 italic text-ink-3">
