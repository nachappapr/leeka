...
function TestimonialCard({ testimonial }: { testimonial: Testimonial }) {
  return (
    <article className="flex flex-col rounded-2xl bg-card p-6 shadow-card">
      ...
      {/* Quote */}
      <p className="flex-1 text-body font-medium leading-snug text-ink">{testimonial.quote}</p>
      ...
      <div className="mt-4.5 flex items-center gap-2.5 border-t border-border pt-4">
        ...
        <div>
          <div className="text-14 font-extrabold text-ink">{testimonial.author}</div>
