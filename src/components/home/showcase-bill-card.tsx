...
function ShowcaseBillCard({ nameHi, amount, statusClass, dotClass, statusHi }: ShowcaseBillCardProps) {
  return (
    <div className="bg-card rounded-xl px-3 py-2.5 shadow-card">
      ...
      <div className="mt-1">
        <span className={`inline-flex items-center gap-1 rounded-full px-1.5 py-px text-9 font-extrabold ${statusClass}`}>
