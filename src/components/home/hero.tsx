          ...
          <div>
            ...
            <h1 className="font-extrabold leading-tight tracking-tight text-ink text-display max-tablet:text-h1 max-mobile:text-36">
              ...
              <span className="relative inline-block text-coral">
                WhatsApp.
                <HeroUnderline
                  className="block w-full -mt-1 h-3.5 text-coral"
                  aria-hidden="true"
                />
              </span>
            </h1>
            ...
            <p className="mt-5 max-w-130 text-19 leading-relaxed text-ink-2 max-tablet:text-17 max-mobile:text-body">
              ArthaPatra is a web app for India&#39;s small shops, home bakers, tailors and
              traders. Open it in any browser, create a bill in 60 seconds, send it on
              WhatsApp, get paid faster.{" "}
