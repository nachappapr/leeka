      ...
      <div className="mx-auto max-w-7xl px-8 max-mobile:px-5">
        ...
        <div className="mx-auto mb-14 max-w-180 text-center">
          ...
          <p className="mt-3.5 text-18 leading-snug text-ink-2 max-mobile:text-body">
            Not a watered-down version of accounting software. Built ground-up
            for vendors who chat with customers on WhatsApp, take payments in
            cash and UPI, and don&apos;t have time for spreadsheets.
          </p>
        </div>
