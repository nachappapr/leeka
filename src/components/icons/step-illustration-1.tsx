...
export function StepIllustration1(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg
      ...
      {...props}
    >
      <rect x="10" y="14" width="160" height="22" rx="10" fill="#fff" stroke="#ECE3D4" strokeWidth="1.5" />
      ...
      <path d="M152 25l2.5 2.5L158 22.5" stroke="#fff" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" />
      <rect x="10" y="46" width="160" height="22" rx="10" fill="#FBF6EF" stroke="#ECE3D4" strokeWidth="1.5" />
      ...
      <rect x="10" y="78" width="160" height="14" rx="7" fill="#FFE7DA" stroke="#F46A39" strokeWidth="1.5" strokeDasharray="3 3" />
      <text x="90" y="88" textAnchor="middle" fontFamily="'Plus Jakarta Sans'" fontSize="9" fill="#5A1E08" fontWeight="800">+ Add new customer</text>
    </svg>
  )
}
