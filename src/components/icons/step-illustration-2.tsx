...
export function StepIllustration2(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg
      ...
      {...props}
    >
      <rect x="10" y="14" width="160" height="20" rx="6" fill="#fff" stroke="#ECE3D4" strokeWidth="1.5" />
      ...
      <rect x="10" y="38" width="160" height="20" rx="6" fill="#fff" stroke="#ECE3D4" strokeWidth="1.5" />
      ...
      <text x="160" y="84" textAnchor="end" fontFamily="'Plus Jakarta Sans'" fontSize="13" fill="#fff" fontWeight="800">₹4,725</text>
    </svg>
  )
}
