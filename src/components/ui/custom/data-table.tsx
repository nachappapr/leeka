...
function DataHeader({ className, ...props }: React.ComponentProps<typeof TableHeader>) {
  return (
    <TableHeader
      className={cn(
...
function DataHead({ className, ...props }: React.ComponentProps<typeof TableHead>) {
  return (
    <TableHead
      scope="col"
      className={cn(
...
function DataBody({ ...props }: React.ComponentProps<typeof TableBody>) {
  return <TableBody {...props} />;
}

function DataRow({ className, ...props }: React.ComponentProps<typeof TableRow>) {
  return (
    <TableRow
...
function DataCell({ className, ...props }: React.ComponentProps<typeof TableCell>) {
  return <TableCell className={cn("py-3.5", className)} {...props} />;
}
