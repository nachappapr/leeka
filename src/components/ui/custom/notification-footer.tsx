...
function NotificationFooter({
  ...
  return (
    <footer className="flex shrink-0 items-center justify-between border-t border-border bg-background px-2.5 py-2">
      <Link
        href={viewAllHref}
        className="inline-flex items-center gap-1 rounded-md px-2 py-1 text-12 font-semibold text-ink-2 hover:text-coral focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-coral-press"
      >
        View all activity
