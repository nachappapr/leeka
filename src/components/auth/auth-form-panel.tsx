...
function AuthFormPanel({ mode }: AuthFormPanelProps) {
  return (
    ...
    <div className="flex min-h-screen flex-col bg-background px-5 py-10 max-tablet:min-h-0 max-tablet:mx-auto max-tablet:mt-7 max-tablet:max-w-[620px] max-tablet:rounded-2xl max-tablet:pt-9 max-tablet:px-11 max-tablet:pb-10 max-tablet:[box-shadow:0_30px_70px_rgba(40,15,4,0.32),0_10px_24px_rgba(40,15,4,0.18)] max-mobile:rounded-none max-mobile:shadow-none max-mobile:mx-0 max-mobile:mt-0 max-mobile:max-w-none max-mobile:px-5 max-mobile:py-7">
      {/* Top bar */}
      ...
      {/* Form card */}
      {/* eslint-disable-next-line better-tailwindcss/no-restricted-classes -- D-FORM-WIDTH: 440px desktop card width; no canonical token covers 440px */}
      <div className="mx-auto w-full max-w-[440px] my-auto max-tablet:my-0 max-tablet:max-w-none max-mobile:max-w-full">
